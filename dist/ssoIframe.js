(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ssoIframe"] = factory();
	else
		root["ssoIframe"] = factory();
...
var Base64 = { _keyStr: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", encode: function encode(e) {
		...
		var t = "";var n = 0;var r = 0;var c2 = 0;while (n < e.length) {
...
var _sso_common = __webpack_require__(0);

var _sso_rest = __webpack_require__(2);
...
function doLogout() {
  ...
  if ((0, _sso_common.isSafariBrowser)()) {
    (0, _sso_common.deleteCookieByName)(safariCookie);
  }
  onLogout();
}
...
function doLogin(jwt) {
  ...
  if ((0, _sso_common.isSafariBrowser)()) {
    (0, _sso_common.setPersistentCookie)(safariCookie, jwt);
  }
  /*if (isIE()){
...
function validateJWTRemote(jwtsso) {
  var jwt = new _sso_common.JWT(jwtsso);
  var rest = new _sso_rest.RestClient(validationUrl, accountId, apiKey);
...
function ready() {
  ...
  if ((0, _sso_common.isSafariBrowser)()) {
    var jwtsso = (0, _sso_common.getCookieByName)(safariCookie);
  } else {
    var jwtsso = localStorage.getItem(tokenId);
  }
  if (jwtsso) {
...
function init() {
  accountId = (0, _sso_common.getGetParam)("accountId");
  domain = (0, _sso_common.getGetParam)("domain");
  validationUrl = (0, _sso_common.getGetParam)("validationUrl");
  validate = !((0, _sso_common.getGetParam)("validate") == 'false');
  if (validate && !validationUrl) validationUrl = (0, _sso_common.getOrigin)() + '/validate';
...
function RestClient(host, accountId, apiKey, scheme) {
	...
	function _makeAuth(scheme, user, password) {
		...
		if (window.btoa) {
			...
			hash = _sso_common.Base64.encode(tok);
		}
		return scheme + " " + hash;
	}
